...
from web_scraping.civil_status_and_passports_department_req_status import (
    civil_status_and_passports_department_req_status,
)
...
processes = {
    "111": [
        "الإستعلام عن المخالفات",
        3,
        [
            " أمانة عمان الكبرى - الإستعلام عن المخالفات\n\n أدخل رقم المركبة لطفاً",
            "أدخل الترميز",
            "أدخل رقم التسجيل",
        ],
        vehicle_validation,
    ...
    "12": [
        "المالية لوزارة المالية",
        1,
        [
            "الذمم المالية المتحققة بذمتكم لوزارة المالية / مديرية الأموال العامة\n\nأدخل الرقم الوطني لطفاً"
        ],
        financial_status,
    ],
    "13": [
        ...
        1,
        [
            "الاستعلام عن قيم مخالفات السير حسب قانون السير رقم 48\n\n أدخل جزء من وصف المخالفة لطفاً"
        ],
        violations_lookup,
    ],
    "14": [
        "ضريبة الأبنية والمسقفات",
        2,
        ["ضريبة الأبنية والمسقفات\n\n أدخل الرقم الوطني لطفاً", "أدخل رقم الهوية"],
        roof_tax,
    ],
    "15": [
        "الاستعلام عن قطعة أرض",
        1,
        ["دائرة الأراضي والمساحة - الاستعلام عن قطعة أرض\n\n أدخل مفتاح القطعة لطفاً"],
        land_location,
    ],
    "16": [
        "معلومات المشترك في الضمان الاجتماعي",
        2,
        [
            "المؤسسة العامة للضمان الاجتماعي - لوحة معلومات المشترك\n\n أدخل اسم المستخدم في موقع المؤسسة العامة للضمان الاجتماعي لطفاً",
            "أدخل الباسوورد",
        ],
        social_security,
    ],
    "17": [
        "الترتيب التنافسي في ديوان الخدمة المدنية",
        2,
        [
            "ديوان الخدمة المدنية - الترتيب التنافسي\n\n أدخل الرقم الوطني لطفاً",
            "أدخل رقم الهوية",
        ],
        competitive_ranking,
    ],
    "18": [
        "المؤسسة العامة للضمان الإجتماعي - كتب لمن يهمه الأمر",
        2,
        [
            "المؤسسة العامة للضمان الإجتماعي - كتب لمن يهمه الأمر\n\n أدخل اسم المستخدم في موقع المؤسسة العامة للضمان الاجتماعي لطفاً",
            "أدخل الباسوورد",
    ...
    "19": [
        "الأحوال المدنية و الجوازات - متابعة الطلبات",
        2,
        [
            "الأحوال المدنية و الجوازات - متابعة الطلبات\n\n أدخل اسم المستخدم في موقع دائرة الأحوال المدنية و الجوازات لطفاً",
            "أدخل الباسوورد",
        ],
        civil_status_and_passports_department_req_status,
    ],
    "20": [
        "الأحوال المدنية و الجوازات - إصدار شهادة القيد العائلي",
        2,
        [
            "الأحوال المدنية و الجوازات - إصدار شهادة القيد العائلي\n\n أدخل اسم المستخدم في موقع دائرة الأحوال المدنية و الجوازات لطفاً",
            "أدخل الباسوورد",
    ...
    "21": [
        ...
        3,
        [
            "أمانة عمان الكبرى - طلب براءة ذمة\n\n أدخل الرقم الوطني لطفاً",
            "أدخل رقم قيد الهوية\t\t( * * * / * * * )  :Ex",
            "أدخل رقم الهاتف\t( * * * * * * * * 7 0 )  :Ex",
        ],
        clearance,
    ],
}
    ...
    if incoming_msg in processes:
        ...
        if len(responses[process_values]) < processes[current_process][1]:
            ...
            if remaining_responses > 0:
                ...
                if (
                    current_process == "111"
                    or current_process == "11"
                    or current_process == "14"
                    or current_process == "15"
                    or current_process == "16"
                    or current_process == "17"
                    or current_process == "18"
                    or current_process == "19"
                    or current_process == "20"
                ):
